(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ["pages/index/causeForm/causeFormTraffic"], {
    "0210": function(e, t, a) {
      "use strict";
      a.r(t);
      var n = a("bd1f"),
    ...
    "0bad": function(e, t, a) {
      ...
      a("41a8");
      var o = a("828b"),
        s = Object(o["a"])(i["default"], n["b"], n["c"], !1, null, "269fdfda", null, !1, n["a"], void 0);
      t["default"] = s.exports
    },
    "30e7": function(e, t, a) {
      "use strict";
        ...
        var c = {
          ...
          methods: {
              ...
              e.showLoading({
                ...
                success: function(n) {
                  ...
                  a.$causeRequest("/applet/complaint/save", "POST", {
                    ...
                    createStatus: t,
                    cateGory: Number(r) + 1,
                    cateGory8: l(l(l(l(l({}, a.partyFormData), a.claimsFormData), a.jurisdictionFormData), a.factsFormData), {}, {
            ...
            initClaimsFormData: function() {
              this.claimsFormData = l(l({}, this.claimsFormData), {}, {
                ...
                nursingExpenses: "",
                lossIncome: "",
                doctorOrderNursingFee: "",
                hospitalizationCertificate: "",
                nutritionExpenses: "",
                hospitalMealAllowance: "",
                medicalRecord: "",
                periodLossIncome: "",
                wageLoss: "",
                transportationExpenses: "",
                transportationExpensesProof: "",
                disabilityCompensation: "",
                disabilityAidsExpenses: "",
                deathCompensation: "",
                funeralExpenses: "",
                mentalDamageCompensation: "",
                otherExpenses: ""
              }), this.claimsFormSection = [{
                sectionTitle: "诉讼请求和依据",
                sectionFormItems: [{
                  type: "input",
                  ...
                  type: "input",
                  name: "doctorOrderNursingFee",
                  label: "遵医嘱护理费",
                  placeholder: "请输入遵医嘱护理费"
                }, {
                  type: "checkbox",
                  ...
                  type: "input",
                  name: "hospitalMealAllowance",
                  label: "住院伙食补助",
                  placeholder: "请输入住院伙食补助"
                }, {
                  type: "input",
                  name: "periodLossIncome",
                  label: "误工期间",
                  placeholder: "请输入误工期间"
                }, {
                  type: "input",
                  ...
                  type: "checkbox",
                  name: "transportationExpensesProof",
                  label: "交通费凭证",
                  options: this.debtChargeOptions
                }, {
                  type: "input",
                  ...
                  label: "残疾赔偿金",
                  placeholder: "请输入残疾赔偿金"
                }, {
                  type: "input",
                  name: "disabilityAidsExpenses",
                  label: "残疾辅助器具费",
                  ...
                  type: "input",
                  name: "mentalDamageCompensation",
                  label: "精神损害赔偿金",
                  placeholder: "请输入精神损害赔偿金"
                }, {
                  type: "input",
                  name: "otherExpenses",
                  label: "其他费用",
            ...
            initFactsFormData: function() {
              ...
              this.factsFormData = l(l({}, this.factsFormData), {}, {
                trafficAccidentOccurrence: "",
                trafficAccidentResponsibility: "",
                motorVehicleInsurance: "",
                otherSituationsAndLegalBasis: ""
              }), this.factsFormSection.push({
                sectionTitle: "事实和理由",
                sectionFormItems: [{
                  type: "input",
                  name: "trafficAccidentOccurrence",
                  label: "交通事故发生情况",
                  placeholder: "请输入交通事故发生情况"
                }, {
                  type: "input",
                  name: "trafficAccidentResponsibility",
                  label: "交通事故责任认定",
                  placeholder: "请输入交通事故责任认定"
                }, {
                  type: "input",
                  name: "motorVehicleInsurance",
                  label: "机动车投保情况",
                  placeholder: "请输入机动车投保情况"
                }, {
                  type: "input",
                  name: "otherSituationsAndLegalBasis",
                  label: "其他情况及法律依据",
                  placeholder: "请输入其他情况及法律依据",
                  class: "border-bottom-none"
                }]
              })
            },
  ...
  [
    ["4d39", "common/runtime", "common/vendor"]
  ]
]);