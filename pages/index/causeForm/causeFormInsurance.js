(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ["pages/index/causeForm/causeFormInsurance"], {
    "2ea9": function(e, t, a) {
      "use strict";
      var n = a("4ca5"),
        i = a.n(n);
    ...
    4067: function(e, t, a) {
      ...
      a("2ea9");
      var o = a("828b"),
        l = Object(o["a"])(i["default"], n["b"], n["c"], !1, null, "3c5fe8ab", null, !1, n["a"], void 0);
      t["default"] = l.exports
    },
    "4ca5": function(e, t, a) {},
    "88c1": function(e, t, a) {
          ...
          methods: {
              ...
              e.showLoading({
                ...
                success: function(n) {
                  ...
                  a.$causeRequest("/applet/complaint/save", "POST", {
                    ...
                    createStatus: t,
                    cateGory: Number(r) + 1,
                    cateGory10: s(s(s(s(s({}, a.partyFormData), a.claimsFormData), a.jurisdictionFormData), a.factsFormData), {}, {
            ...
            initClaimsFormData: function() {
              this.claimsFormData = {
                ...
                sectionFormItems: [{
                  ...
                  label: "理赔款",
                  placeholder: "请输入理赔款金额"
                }, {
                  type: "date",
                  name: "premiumDeadline",
                  label: "截止日期",
                  placeholder: "请选择截止日期"
                }, {
                  type: "input",
                  name: "outstandingFeeTotal",
                  label: "欠费共计",
                  placeholder: "请输入欠保险费、违约金等共计"
                }, {
                  type: "input",
                  name: "outstandingFeeDetail",
                  label: "欠息明细",
                  placeholder: "请输入欠保险费、违约金明细",
                  class: "border-bottom-none"
                }]
              }]
            },
            ...
            initFactsFormData: function() {
              ...
              this.factsFormData = s(s({}, this.factsFormData), {}, {
                ...
                interestRepaidAmount: "",
                overdueStartDate: "",
                outstandingPrincipalAmount: "",
                outstandingInterestAmount: "",
                outstandingPenaltyInterest: "",
                outstandingCompoundInterest: "",
                outstandingLateFee: "",
                outstandingBreachFee: "",
                outstandingServiceFee: "",
                specificDetails: "",
                compensationDate: "",
                totalCompensationAmount: "",
                confirmationDate: "",
                recoveryNoticeDate: "",
                recoveredPremiumAmount: "",
                recoveredLoanAmount: "",
                outstandingPremiumToRecover: "",
                outstandingLoanPrincipalToRecover: "",
                recoveredInterestAmount: "",
                recoveredPenaltyInterest: "",
                recoveredCompoundInterest: "",
                recoveredLateFee: "",
                recoveredBreachFee: "",
                recoveryServiceFee: "",
                recoverySpecificDetails: ""
              }), this.factsFormSection.push({
                sectionTitle: "保证保险合同签订情况",
                sectionFormItems: [{
                  type: "input",
                  ...
                  type: "input",
                  name: "guaranteeInsuranceAmount",
                  label: "保证保险金额",
                  placeholder: "请输入保证保险金额"
                }, {
                  type: "input",
                  name: "premiumAmount",
                  label: "保费金额",
                  ...
                  type: "dateRange",
                  name: {
                    startTime: "insurancePeriodStart",
                    endTime: "insurancePeriodEnd"
                  },
                  label: "保险期间",
                  ...
                  label: "保费缴纳方式",
                  placeholder: "请输入保费缴纳方式"
                }, {
                  type: "input",
                  name: "compensationConditions",
                  label: "理赔条件",
                  placeholder: "请输入理赔条件"
                }, {
                  type: "input",
                  name: "feeRecovery",
                  label: "费用追索",
                  placeholder: "请输入理赔款项和未付保费的追索"
                }, {
                  type: "input",
                  name: "breachOfContractLiability",
                  label: "违约事由责任",
                  placeholder: "请输入违约事由责任"
                }, {
                  type: "input",
                  ...
                  label: "说明方式",
                  placeholder: "请输入提示说明的具体方式以及时间地点"
                }, {
                  type: "input",
                  name: "contractAgreementStatus",
                  label: "合同约定情况",
                  placeholder: "请输入借款金额、期限、用途、利息标准等",
                  class: "border-bottom-none"
                }]
              }), this.factsFormSection.push({
                sectionTitle: "合同履行情况",
                sectionFormItems: [{
                  ...
                  type: "inputUnit",
                  name: "overdueRepaidAmount",
                  label: "逾期已还款额",
                  placeholder: "请输入逾期已还款额"
                }, {
                  type: "inputUnit",
                  name: "principalRepaidAmount",
                  label: "归还本金金额",
                  placeholder: "请输入归还本金金额"
                }, {
                  type: "inputUnit",
                  name: "interestRepaidAmount",
                  label: "归还利息金额",
                  placeholder: "请输入归还利息金额"
                }, {
                  type: "date",
                  ...
                  label: "欠本金金额",
                  placeholder: "请输入欠本金金额"
                }, {
                  type: "inputUnit",
                  name: "outstandingInterestAmount",
                  label: "欠利息金额",
                  placeholder: "请输入欠利息金额"
                }, {
                  type: "inputUnit",
                  name: "outstandingPenaltyInterest",
                  label: "欠罚息金额",
                  placeholder: "请输入欠罚息金额"
                }, {
                  type: "inputUnit",
                  name: "outstandingCompoundInterest",
                  label: "欠复利金额",
                  placeholder: "请输入欠复利金额"
                }, {
                  type: "inputUnit",
                  name: "outstandingLateFee",
                  label: "欠滞纳金金额",
                  placeholder: "请输入欠滞纳金金额"
                }, {
                  type: "inputUnit",
                  name: "outstandingBreachFee",
                  label: "欠违约金金额",
                  placeholder: "请输入欠违约金金额"
                }, {
                  type: "inputUnit",
                  name: "outstandingServiceFee",
                  label: "欠手续费金额",
                  placeholder: "请输入欠手续费金额"
                }, {
                  type: "input",
                  ...
                  label: "赔款总金额",
                  placeholder: "请输入赔款总金额"
                }, {
                  type: "date",
                  name: "confirmationDate",
                  label: "取得确认书日期",
                  placeholder: "请选择取得确认书日期",
                  class: "border-bottom-none"
                }]
              }), this.factsFormSection.push({
                sectionTitle: "追索情况",
                sectionFormItems: [{
                  type: "date",
                  name: "recoveryNoticeDate",
                  label: "追索通知日期",
                  placeholder: "请选择追索通知日期"
                }, {
                  type: "inputUnit",
                  name: "recoveredPremiumAmount",
                  label: "已支付保费",
                  placeholder: "请输入已支付保费金额"
                }, {
                  type: "inputUnit",
                  name: "recoveredLoanAmount",
                  label: "归还借款",
                  placeholder: "请输入归还借款金额"
                }, {
                  type: "inputUnit",
                  name: "outstandingPremiumToRecover",
                  label: "尚欠保费",
                  placeholder: "请输入尚欠保费金额"
                }, {
                  type: "inputUnit",
                  name: "outstandingLoanPrincipalToRecover",
                  label: "欠付借款本金",
                  placeholder: "请输入欠付借款本金金额"
                }, {
                  type: "inputUnit",
                  name: "recoveredInterestAmount",
                  label: "欠付利息金额",
                  placeholder: "请输入欠付利息金额"
                }, {
                  type: "inputUnit",
                  name: "recoveredPenaltyInterest",
                  label: "欠罚息金额",
                  placeholder: "请输入欠罚息金额"
                }, {
                  type: "inputUnit",
                  name: "recoveredCompoundInterest",
                  label: "欠复利金额",
                  placeholder: "请输入欠复利金额"
                }, {
                  type: "inputUnit",
                  name: "recoveredLateFee",
                  label: "欠滞纳金金额",
                  placeholder: "请输入欠滞纳金金额"
                }, {
                  type: "inputUnit",
                  name: "recoveredBreachFee",
                  label: "欠违约金金额",
                  placeholder: "请输入欠违约金金额"
                }, {
                  type: "inputUnit",
                  name: "recoveryServiceFee",
                  label: "欠手续费金额",
                  placeholder: "请输入欠手续费金额"
                }, {
                  type: "input",
                  name: "recoverySpecificDetails",
                  label: "具体明细",
                  placeholder: "请输入具体明细",
                  class: "border-bottom-none"
                }]
  ...
  [
    ["eab0", "common/runtime", "common/vendor"]
  ]
]);