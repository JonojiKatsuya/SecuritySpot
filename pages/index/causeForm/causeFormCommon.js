(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ["pages/index/causeForm/causeFormCommon"], {
    1394: function(e, t, a) {
      "use strict";
      (function(e) {
        var n = a("47a9");
        ...
        var u = {
          ...
          methods: {
            ...
            transformClaimsFormData: function(e) {
              var t = Object.keys(e).filter((function(e) {
                  return e.startsWith("request")
                })),
                a = Math.max.apply(Math, (0, o.default)(t.map((function(e) {
                  return parseInt(e.replace("request", ""), 10)
                }))));
              return Array.from({
                length: a
              }, (function(t, a) {
                var n = a + 1,
                  i = e["request".concat(n)],
                  r = e["basis".concat(n)];
                return {
                  infoKey: i,
                  infoValue: r
              ...
              e.showLoading({
                ...
                success: function(n) {
                  ...
                  a.$causeRequest("/applet/complaint/save", "POST", {
                    ...
                    createStatus: t,
                    cateGory: Number(r) + 1,
                    cateGory12: c(c(c(c({}, a.partyFormData), {}, {
                      esAllJsonData: a.transformClaimsFormData(a.claimsFormData)
                    }, a.jurisdictionFormData), a.factsFormData), {}, {
            ...
            initPartyFormData: function() {
              ...
              "1" === e.plaintiff || "2" === e.plaintiff ? (this.partyFormData = c(c({}, this.partyFormData), {}, {
              ...
              })) : (this.partyFormData = c(c({}, this.partyFormData), {}, {
                plaintiffOrgName: "",
              ...
              })), "2" !== e.plaintiff && "4" !== e.plaintiff || (this.partyFormData = c(c({}, this.partyFormData), {}, {
              ...
              })), "1" === e.electronicDelivery ? (this.partyFormData = c(c({}, this.partyFormData), {}, {
                deliveryMessage: "",
                deliveryWechat: "",
                deliveryFax: "",
                deliveryEmail: ""
              ...
              })), "1" === e.defendant ? (this.partyFormData = c(c({}, this.partyFormData), {}, {
              ...
              })), "2" === e.thirdParty && (this.partyFormData = c(c({}, this.partyFormData), {}, {
                thirdPersionName: "",
                thirdGender: "",
                thirdBirthdayDate: "",
                thirdPersionPhone: "",
              ...
              })), "3" === e.thirdParty && (this.partyFormData = c(c({}, this.partyFormData), {}, {
                thirdOrgName: "",
            ...
            initClaimsFormData: function() {
              this.claimsFormData = c(c({}, this.claimsFormData), {}, {
                request1: "",
                request2: "",
                request3: "",
                request4: "",
            ...
            initFactsFormData: function() {
              ...
              this.factsFormData = c(c({}, this.factsFormData), {}, {
                fact: "",
                reasion: ""
              }), this.factsFormSection.push({
                sectionTitle: "事实情况和具体理由",
                sectionFormItems: [{
                  type: "textarea",
                  name: "fact",
                  label: "事实情况",
            ...
            setTabFormData: function() {
              var e = this,
                ...
                a = function(a) {
                  ...
                  if ("paymentType" === a) {
                    var p = e.paymentTypeOptions.find((function(e) {
                      return e.text === t[a]
                    }));
                    t[a] = p ? p.value : ""
                  }
          ...
          computed: c({}, (0, s.mapState)(["cause", "causeBaseFormData"])),
          watch: {
            partyFormData: {
              handler: function() {
    ...
    "1f21": function(e, t, a) {
      ...
      a("8f7c");
      var o = a("828b"),
        s = Object(o["a"])(i["default"], n["b"], n["c"], !1, null, "fa0964ce", null, !1, n["a"], void 0);
      t["default"] = s.exports
    },
    4762: function(e, t, a) {
      "use strict";
      ...
      var n = {
        ...
        i = function() {
          var e = this,
            t = e.$createElement,
            a = (e._self._c, Object.keys(e.jurisdictionFormData).length);
  ...
  [
    ["93fc", "common/runtime", "common/vendor"]
  ]
]);