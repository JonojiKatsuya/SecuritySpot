(global["webpackJsonp"] = global["webpackJsonp"] || []).push([
  ["pages/index/causeForm/causeFormLoan"], {
    "149c": function(e, t, a) {
      "use strict";
      a.r(t);
      var n = a("93c7"),
        ...
        var c = {
          ...
          methods: {
              ...
              e.showLoading({
                ...
                success: function(n) {
                  ...
                  a.$causeRequest("/applet/complaint/save", "POST", {
                    ...
                    createStatus: t,
                    cateGory: Number(r) + 1,
                    complaint: l(l(l(l(l({}, a.partyFormData), a.claimsFormData), a.jurisdictionFormData), a.factsFormData), {}, {
            ...
            initFactsFormData: function() {
              var e = this.$store.state.causeBaseFormData;
              "1" !== e.contract && "2" !== e.contract || (this.factsFormData = l(l({}, this.factsFormData), {}, {
                contractDesc: "",
                contractLender: "",
                contractBorrower: "",
                actualLoanAmount: "",
                ...
                sectionFormItems: [{
                  ...
                  label: "约定借款金额",
                  placeholder: "请输入约定借款金额"
                }, {
                  type: "inputUnit",
                  name: "loanProvideAmount",
                  label: "实际提供金额",
                  placeholder: "请输入实际提供金额"
                }, {
                  type: "date",
                  name: "loanProvideDate",
                  label: "实际提供时间",
                  placeholder: "请选择实际提供时间"
                }, {
                  type: "checkbox",
                  name: "loanTerm",
                  label: "是否到期",
                ...
                sectionFormItems: [{
                  type: "inputUnit",
                  name: "repairedPrincipal",
                  label: "已还本金",
                  placeholder: "请输入已还本金金额"
                }, {
                  type: "inputUnit",
                  name: "repaidInterest",
                  label: "已还利息",
                  placeholder: "请输入已还利息金额"
                }, {
                  type: "overdueRepayment",
                  name: "overdueRepayment",
                  label: "逾期还款",
                  labelPosition: "top",
                  class: "overdue-repay-item border-bottom-none"
                }]
              }), "2" !== e.thirdParty && "3" !== e.thirdParty || (this.factsFormData = l(l({}, this.factsFormData), {}, {
                guarantee: "",
                guaranteeDate: "",
                guarantor: "",
                collateral: "",
                ...
                sectionFormItems: [{
                  ...
                  name: "registType",
                  label: "抵押、质押登记",
                  options: this.registTypeOptions,
                  labelPosition: "top"
                }, {
                  type: "checkbox",
                  name: "isRegist",
                  ...
                  label: "签订保证合同",
                  options: this.guaranteeContractOptions
                }, {
                  type: "checkbox",
                  name: "otherGuarantor",
                  label: "其他担保方式",
                  ...
                  type: "input",
                  name: "otherGuarantorType",
                  label: "其他担保形式",
                  placeholder: "请输入其他担保形式"
                }, {
                  type: "date",
                  name: "otherGuaranteeContractDate",
                  label: "其他担保时间",
                  placeholder: "请选择其他担保签订时间"
                }, {
                  type: "date",
                  name: "guaranteeContractDate",
                  label: "合同签订时间",
                  placeholder: "请选择合同签订时间"
                }, {
                  type: "input",
                  name: "guaranteePersion",
                  label: "保证人",
    ...
    bb34: function(e, t, a) {
      ...
      a("5a17");
      var o = a("828b"),
        s = Object(o["a"])(i["default"], n["b"], n["c"], !1, null, "2d81a0bc", null, !1, n["a"], void 0);
      t["default"] = s.exports
    }
  },
  [
    ["980c", "common/runtime", "common/vendor"]
  ]
]);